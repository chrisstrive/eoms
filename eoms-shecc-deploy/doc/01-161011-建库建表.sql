...
(
   ...
   MODEL_ID             int comment '所属型号编号',
   MODEL_NAME           VARCHAR(100) comment '所属型号名称',
   ...
   LOCATION_FNAME       VARCHAR(100) comment '位置全名',
   ...
   ROUTING_TIME         datetime comment '巡检时间',
...
(
   ...
   REPAIR_APPLY_TIME    DATETIME comment '报修时间',
   RESPONSE_TIME        DATETIME comment '响应时间',
   ARRIVE_TIME          DATETIME comment '到达时间',
   COMPELTE_TIME        DATETIME comment '完成时间',
