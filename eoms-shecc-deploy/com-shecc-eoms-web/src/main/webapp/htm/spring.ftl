...
<#macro static>${rc.contextPath}/static</#macro>
<#macro contextPath>${rc.contextPath}</#macro>
<#-- local file domain -->
<#macro image>http://localhost:8080/web-static/</#macro>
<#-- test file domain -->
<#--<#macro image>http://115.29.236.65:8080/web-static/</#macro>-->
<#-- product file domain -->
<#--<#macro image>http://1074.nmgums.com/web-static/</#macro>-->


<#--<#include "common/macro/menu.ftl">-->
<#--<#include "common/macro/navigation.ftl">-->
<#--<#include "common/macro/online.ftl">-->
<#--<#include "common/macro/pager.ftl">-->
<#--<#include "common/macro/orderbtn.ftl">-->
